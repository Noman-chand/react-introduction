...
import { deleteCart } from '../../../Fetures/apiSlice';
                        ...
                        <div key={item.id} className="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
                            ...
                            <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                                <div className="mt-5 sm:mt-0">
                                    <h2 className="text-lg font-bold text-gray-900">{item.category}</h2>
                                ...
                                <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <button onClick={() => dispatch(deleteCart(item.id))}>
                                            <MdDeleteForever className="h-5 w-5 cursor-pointer duration-150 hover:text-red-500" />
                                        </button>
                                    </div>
                                </div>
                            </div>
